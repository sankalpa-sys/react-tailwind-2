...
function Contact(props) {
  return (
    <div className="flex flex-col">
      <div className="flex h-96 bg-gray-900 justify-between  items-center ">
        ...
        <div className="">
          <img
            src={Contactt}
            alt=""
            className="h-96 rounded-l-full flex-grow overflow-hidden"
          />
        </div>
      </div>
      {/* cards */}
      <div className=" inline-block space-y-2 mt-4 mb-4 md:flex justify-around items-center md:my-4">
        <div className="bg-red-900 h-96 text-white rounded-r-full shadow-lg hover:scale-105 transform transition duration-300 ease-in  ">
          <div className="flex flex-col items-center pt-5 px-5">
            ...
            <p className="my-2">
              Interested in Dokan? Just pick up the phone to chat with the
        ...
        <div className="bg-green-900 h-96 text-white   rounded-l-full shadow-lg hover:scale-105 transform transition duration-300 ease-in">
          <div className="flex flex-col items-center pt-5 px-5">
            ...
            <h1 className="mt-5 text-xl font-bold mb-5">
              Contact Customer Support
            </h1>
            <p className="my-2">
              Buy and sell anything you want from the Dokan website. Its easy
              and secure.
            </p>
          </div>
        </div>
      ...
      <hr />
      <div className= {`md:border-2 rounded-2xl w-[80%] flex border-${props.borderColor} flex-col items-center py-4 px-4 mx-2 mt-4 mb-4 self-center md:shadow-2xl`}>
        <h1 className={`text-4xl my-4 animate-pulse text-${props.textColor}`}>
          Message Us
        </h1>
        <div class="flex space-x-8 justify-center">
          <input
            ...
            className={`contact_form bg-${props.fieldBg} `}
          />
          <input
            type="text"
        ...
        <button className=" bg-purple-500 text-white rounded-full px-2 py-2 hover:scale-105 transform transition duration-300 ease-out shadow-xl hover:bg-purple-600 active:bg-red-600 active:scale-90 ring-2">
          Submit
        </button>
      </div>
    </div>
