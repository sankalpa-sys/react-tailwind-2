...
function Items(props) {
    ...
    return (
        <div className={`grid grid-cols-1 justify-center sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-4 space-x-4 space-y-6 my-6 items-center mx-4  text-${props.textColor}`}>
            {results.map((element)=> (
